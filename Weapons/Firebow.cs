...
namespace SpellFall.Weapons
{
    public class Firebow : Weapons
    {
        ...
        public Firebow() : base(damageBonus: 5, baseCdFrames: 36, fireRateBonus: 0.2f)
        {
            _target = Point.Zero;
        ...
        {
            _bowTexture = content.Load<Texture2D>("Firebow");
            base.Load(content);
        }
        ...
        public override void HandleInput(InputManager inputManager)
        {
            ...
            if (inputManager.LeftMousePress() && TryStartPrimaryAttackCooldown())
            {
                ...
                _gameManager.AddGameObject(new FireArrow(_bowCenter, aimDirection, 300f, totalDamage));
            }

...
namespace SpellFall.Weapons
{
    public class Poisonbow : Weapons
    {
        ...
        public Poisonbow() : base(damageBonus: 5, baseCdFrames: 60, fireRateBonus: 0.2f)
        {
            _target = Point.Zero;
        ...
        public override void HandleInput(InputManager inputManager)
        {
                ...
                if (inputManager.LeftMouseDown() && TryStartPrimaryAttackCooldown())
            {
                ...
                _gameManager.AddGameObject(new PoisonArrow(_bowCenter, aimDirection, 360f, totalDamage));
            }

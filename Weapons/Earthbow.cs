...
namespace SpellFall.Weapons
{
    public class Earthbow : Weapons
    {
        ...
        public Earthbow() : base(damageBonus: 5, baseCdFrames: 36, fireRateBonus: 0.2f)
        {
            _target = Point.Zero;
        ...
        public override void HandleInput(InputManager inputManager)
        {
            ...
            if (inputManager.LeftMousePress() && TryStartPrimaryAttackCooldown())
            {
                ...
                _gameManager.AddGameObject(new StoneAmmo(_bowCenter, aimDirection, 300f, totalDamage));
            }

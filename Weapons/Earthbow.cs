...
namespace SpellFall.Weapons
{
    public class Earthbow : Weapons
    {
        ...
        public Earthbow() : base(damageBonus: 10, baseCdFrames: 60, fireRateBonus: 0.2f)
        {
            _target = Point.Zero;
        ...
        {
            _bowTexture = content.Load<Texture2D>("Earthbow");
            base.Load(content);
        }
        ...
        public override void HandleInput(InputManager inputManager)
        {
                ...
                if (inputManager.LeftMouseDown() && TryStartPrimaryAttackCooldown())
            {
                ...
                _gameManager.AddGameObject(new StoneAmmo(_bowCenter, aimDirection, 340f, totalDamage));
            }
